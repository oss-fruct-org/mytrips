...
public class EditPointDialog extends DialogFragment implements DialogInterface.OnClickListener, CategoriesDialog.Listener {
	...
	public interface Listener {
		void pointCreated(Point point, String track);
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        trackSpinner = (Spinner) view.findViewById(R.id.track_spinner);
        if(!isNewPoint)
            trackSpinner.setEnabled(false);
		setupCategorySpinner(categorySpinner);
        setupTrackSpinner(trackSpinner);
	...
	public void onClick(DialogInterface dialogInterface, int i) {
		...
		if (listener != null) {
			if (isNewPoint)
				listener.pointCreated(point, selectedTrack);
			else
    ...
    public void setupTrackSpinner(Spinner spinner){

        ArrayAdapter<String> tracksAdapter = new ArrayAdapter<String>(getActivity(),
        ...
        spinner.setAdapter(tracksAdapter);
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
               selectedTrack = trackNames.get(i);
            }
