	...
	private ActionMode.Callback actionModeCallback = new ActionMode.Callback() {
		...
		public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
           ...
           if(!selectedTrack.isPrivate() || !pref.getBoolean(ConfigFragment.PREF_IS_TRUSTED,false)){
            ...
            }else{ // check if trakc is being recorded
                if( TrackRecorder.getInstance().getTrack() != null &&
                        TrackRecorder.getInstance().getTrack().equals(selectedTrack)) {
                    menu.findItem(R.id.action_record).setIcon(R.drawable.ic_record_stop);
                }
            }
		...
		public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            ...
            case R.id.action_record:
                if( TrackRecorder.getInstance().getTrack() != null &&
                    ...
                    Toast.makeText(getActivity(), "Track recording stopped", Toast.LENGTH_SHORT).show();
                }else {
                    menuItem.setIcon(R.drawable.ic_record_stop);
                    TrackRecorder.getInstance().setTrack(selectedTrack);
                    Toast.makeText(getActivity(), "Track recording started", Toast.LENGTH_SHORT).show();
                }
			default:
				return false;
			}
